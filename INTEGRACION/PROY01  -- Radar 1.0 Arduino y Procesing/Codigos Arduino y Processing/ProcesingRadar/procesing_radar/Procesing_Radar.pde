...
void serialEvent (Serial myPort) { 
 ...
 distance= data.substring(index1+1, data.length()); // read the data from position "index1" to the end of the data pr thats the value
                                                    // of the distance
...
void drawText() { 
 ...
 textSize(28);
 text("www.rendonelectronica.com", width-width*0.875, height-height*0.0277);

...
Para otros errores consultar el foro de arduino:
...
void setup()
{
  ...
  // Inicializamos los servomotores a la posición 0
    // Mensajes al puerto de serie
  Serial.println( "2.- INICIALIZAMOS SERVOS" );

  moveServoSmoothly( servo4, 90, SPEEDSERVO );  // Servo4 - Pinza      
  moveServoSmoothly( servo1, 90, SPEEDSERVO );  // Servo1 - Cadera     
  moveServoSmoothly( servo2, 45, SPEEDSERVO );  // Servo2 - Antebrazo 
  moveServoSmoothly( servo3, 45, SPEEDSERVO );  // Servo3 - Codo       

  // Mensajes al puerto de serie
  Serial.println( "3.- CONFIGURANDO ENTORNO OK" );
  ...
  // Mensajes al puerto de serie
  Serial.println( "7.- PREPARADO PARA TRABAJAR" );
  Serial.println( "---------------------------" );
  Serial.println(); Serial.println();

  // Espera 5 segundos
  delay( 10000 - TIME_MILLIS ); 
...
void InitDance() {
  ...
  // Mensajes al puerto de serie
  Serial.println( "5.- INICIAMOS BAILE" );
  ...
  moveServoSmoothly( servo2, 90, SPEEDSERVO );
  moveServoSmoothly( servo3, 90, SPEEDSERVO );
  moveServoSmoothly( servo4, 02, SPEEDSERVO );

  // Mensajes al puerto de serie
  Serial.println( "6.- INICIAMOS BAILE OK" );
